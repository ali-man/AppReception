...
from hsm.views import print_booking, organization, add_guest, HomeViews, profile, statistics, TasksViews, GuestsViews, ChessViews, BookingViews, \
    StatusBookingViews, EditBookingViews, DetailBookingViews, user_login, user_logout, user_register, ListBookingViews, \
    printer
